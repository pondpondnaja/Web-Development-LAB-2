            ...
            <?php
                if(!empty($_SESSION['user_login']) and $_SESSION['status'] == 'Admin'){
                    ...
                    echo "<form class='form-inline my-lg-0 mr-2'>
                        ...
                        <form class='form-inline my-lg-0 mr-2'>
                            <a href='pages/accountdetail.php?user=$user_name' class='btn btn-primary my-2 my-sm-0 text-capitalize'>$user_name_de</a>
                        </form>";
                }else{
                    echo "<form class='form-inline my-lg-0 mr-2'>
                            <a href='pages/cartinfo.php?' class='btn btn-outline-primary my-2 my-sm-0 text-uppercase'>
                                <spane class='h5'>
                                    <i class='fa fa-shopping-cart pr-2' aria-hidden='true'></i>
                        ...
                        <form action='pages/accountdetail.php' class='form-inline my-lg-0 mr-2'>
                                ...
                                echo"<div class='login-form'>
                                    <div class='row justify-content-center'>
                                        <div class='col-12 col-md-12 col-lg-12'>
                                            ...
                                            <div class='card-body'>
                                                <a href='pages/login.php' class='btn btn-success text-center text-uppercase form-control'>
                                        ...
                                        <div class='col-12 col-md-12 col-lg-12'>
                                            <div class='card'>
                                                ...
                                                <div class='card-body bg-light border-bottom border-left border-right border-top border-dark'>
                                                    ...
                                                    <div class='form-group row mt-4'>
                                                        <div class='col-12 col-md-12 col-lg-12'>
                                                            <a href='pages/accountdetail.php?user=$user' class='btn btn-primary text-center text-uppercase form-control'>
                                            ...
                                            <div class='card-body'>
                                                <a href='pages/cartinfo.php?id=$user_id' class='btn btn-success text-center text-uppercase form-control'>
                                                    <i class='fa fa-shopping-cart pr-2' aria-hidden='true'></i>My cart
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class='col-12 col-md-8 col-lg-9'>
                    <article>
                        <div class='container-fluid mt-2'>
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12">
                                    <img class="fit-image" src="http://placehold.it/500x500" alt="hot_new_image"
                                        style="height: 12rem;">
                                </div>
                            </div>
                            <div class='row mt-2'>
                                <?php
                                    ...
                                    $sql_promotion = "SELECT * FROM `product` WHERE product_type = 3";
                                    $result = mysqli_query($conn, $sql_promotion);
                                    $textmore = 'More info';
                                    $checkprice = "";
                            ...
                            <div class="row mt-2">
                                <?php
                                    require('assets/config/config.php');
                                    mysqli_set_charset($conn, "utf8");
                                    $sql_promotion = "SELECT * FROM `product` WHERE product_type = 1";
                                    $result = mysqli_query($conn, $sql_promotion);
                                    $textmore = 'More info';
                                    $img_path = "assets/uploads/"; 
                                    if (mysqli_num_rows($result) > 0) {
                            ...
                            <div class="row mt-2">
                                <?php
                                    require('assets/config/config.php');
                                    mysqli_set_charset($conn, "utf8");
                                    $sql_promotion = "SELECT * FROM `product` WHERE product_type = 4";
                                    $result = mysqli_query($conn, $sql_promotion);
                                    $textmore = 'More info';
                                    $img_path = "assets/uploads/"; 
                                    if (mysqli_num_rows($result) > 0) {
                                            ...
                                            echo "<div class='col-12 col-md-6 col-lg-3 mb-3 d-flex justify-content-center'>
                                                    <form action='querys/addtocart.php?id=$id' method='POST'>
                                                        <div class='card h-100'>
                                                            ...
                                                            <div class='card-body border-top text-center border-success'>
                                                                <span class='h6'>
                                                                    Price : ".number_format($nomal)."
                                                                </span>
                                                            </div>
